...
import biz.thinkcomputers.shdc.MarkAttendanceStudentList;
...
public class MarkAttendanceClassActivity extends AppCompatActivity implements View.OnClickListener {
    int college_id,user_id,academicyearid,degreeitem,sectionitem,emp_Id,role;

    String semester;
    TextView mark_date,lectureTypeTV;
    ...
    String lectureTime,lectureType;


    WebServiceClass webServiceClass5 = new WebServiceClass();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_class_markattendance);
        ...
        dialog =new ProgressDialog(MarkAttendanceClassActivity.this);
        ...
        new AsyncTask<String,Void,Void>(){
            ...
            protected Void doInBackground(String... params) {
                SoapObject request = new SoapObject(webServiceClass5.getNAMESPACE(),webServiceClass5.getMETHOD_NAME2());
                ...
                HttpTransportSE androidTransport = new HttpTransportSE(webServiceClass5.getURL());
                try {
                    androidTransport.call(webServiceClass5.getNAMESPACE()+webServiceClass5.getMETHOD_NAME2(),envelope);
        ...
        new AsyncTask<String,Void,Void>(){
            ...
            @Override
            protected Void doInBackground(String... params) {
                SoapObject request = new SoapObject(webServiceClass5.getNAMESPACE(), webServiceClass5.getMETHOD_NAME3());
                request.addProperty("college_Id", college_id);
               // request.addProperty("user_Id",user_id);
                //request.addProperty("user_RoleId",role);
                ...
                HttpTransportSE httpTransportSE = new HttpTransportSE(webServiceClass5.getURL());
                try {
                    httpTransportSE.call(webServiceClass5.getNAMESPACE()+webServiceClass5.getMETHOD_NAME3(), envelope);
                    SoapPrimitive response = (SoapPrimitive) envelope.getResponse();
                ...
                if (position == 0) {
                   ...
                   // Toast.makeText(getApplicationContext(), "Select Program", Toast.LENGTH_LONG).show();
                    ...
                    new AsyncTask<String, Void, Void>() {
                        @Override
                        protected Void doInBackground(String... params) {
                            SoapObject request = new SoapObject(webServiceClass5.getNAMESPACE(), webServiceClass5.getMETHOD_NAME5());
                            request.addProperty("college_Id", college_id);
                            ...
                            HttpTransportSE httpTransportSE = new HttpTransportSE(webServiceClass5.getURL());
                            try {
                                httpTransportSE.call(webServiceClass5.getNAMESPACE()+webServiceClass5.getMETHOD_NAME5(), envelope);
                                SoapPrimitive response = (SoapPrimitive) envelope.getResponse();
                                String result = response.toString();
                                JSONArray jsonArray = new JSONArray(result);
                ...
                //Section_Id = parent.getSelectedItemPosition();
                    ...
                    if (position == 0) {
                        ...
                        new AsyncTask<String, Void, Void>() {
                            @Override
                            protected Void doInBackground(String... params) {
                                SoapObject request = new SoapObject(webServiceClass5.getNAMESPACE(),webServiceClass5.getMETHOD_NAME6());
                                ...
                                HttpTransportSE httpTransportSE = new HttpTransportSE(webServiceClass5.getURL());
                                try {
                                    httpTransportSE.call(webServiceClass5.getNAMESPACE()+webServiceClass5.getMETHOD_NAME6(), envelope);
                                    SoapPrimitive response = (SoapPrimitive) envelope.getResponse();
                                    String result = response.toString();
                                    JSONArray jsonArray = new JSONArray(result);
                    ...
                    if (position == 0) {
                       ...
                       // Toast.makeText(getApplicationContext(), "Select Semester", Toast.LENGTH_LONG).show();
                        ...
                        new AsyncTask<String, Void, Void>() {
                            @Override
                            protected Void doInBackground(String... params) {
                                SoapObject request = new SoapObject(webServiceClass5.getNAMESPACE(), webServiceClass5.getMETHOD_NAME7());
                                ...
                                HttpTransportSE httpTransportSE = new HttpTransportSE(webServiceClass5.getURL());
                                try {
                                    httpTransportSE.call(webServiceClass5.getNAMESPACE()+webServiceClass5.getMETHOD_NAME7(), envelope);
                                    SoapPrimitive response = (SoapPrimitive) envelope.getResponse();
                                    String result = response.toString();
                                    JSONArray jsonArray = new JSONArray(result);
                ...
                //Section_Id = parent.getSelectedItemPosition();
                    ...
                    if (position == 0) {
                        ...
                        new AsyncTask<String, Void, Void>() {
                            @Override
                            protected Void doInBackground(String... params) {
                                SoapObject request = new SoapObject(webServiceClass5.getNAMESPACE(), webServiceClass5.getMETHOD_NAME8());
                                ...
                                HttpTransportSE httpTransportSE = new HttpTransportSE(webServiceClass5.getURL());
                                try {
                                    httpTransportSE.call(webServiceClass5.getNAMESPACE()+webServiceClass5.getMETHOD_NAME8(), envelope);
                                    SoapPrimitive response = (SoapPrimitive) envelope.getResponse();
                                    String result = response.toString();
                                    JSONArray jsonArray = new JSONArray(result);
                ...
                //Section_Id = parent.getSelectedItemPosition();
                    ...
                    if (position == 0) {
                        ...
                        new AsyncTask<String, Void, Void>() {
                            @Override
                            protected Void doInBackground(String... params) {
                                SoapObject request = new SoapObject(webServiceClass5.getNAMESPACE(), webServiceClass5.getMETHOD_NAME9());
                                ...
                                HttpTransportSE httpTransportSE = new HttpTransportSE(webServiceClass5.getURL());
                                try {
                                    httpTransportSE.call(webServiceClass5.getNAMESPACE()+webServiceClass5.getMETHOD_NAME9(), envelope);
                                    SoapPrimitive response = (SoapPrimitive) envelope.getResponse();
                                    String result = response.toString();
                                    JSONArray jsonArray = new JSONArray(result);
                            ...
                            protected void onPostExecute(Void aVoid) {
                                ...
                                lt.setLectureTime_Id(0);
                                lt.setLectureTime_Name("Select Lecture Time");
                                lectureTimeArrayList.add(0, lt);
                                lectureTimeAdapter = new LectureTimeAdapter(getApplicationContext(), lectureTimeArrayList);

                                if(lectureTimeAdapter.getCount() > 1){

                                    lectureTimeSpinner.setAdapter(lectureTimeAdapter);

                                }else{

                                    String msg = "No Lecture Time Available";
                                    Toast.makeText(getApplicationContext(), msg, Toast.LENGTH_LONG).show();
                                }
       ...
       // lectureTime.setText(lectureTimeArrayList.get(Subject_Id).getLectureTime_Type().toString());

        lectureTimeSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, final int position, long j) {
                ...
                if (position == 0) {
                   ...
                   // Toast.makeText(getApplicationContext(), "Select Lecture Time", Toast.LENGTH_LONG).show();

                } else {

                    /*LectureTime lectreTime = (LectureTime) parent.getItemAtPosition(position);

                    Lecture_Id = lectreTime.getLectureTime_Id();*/
                    /*lectureTime = lectureTimeArrayList.get(position).getLectureTime_Name();
                    lectureType = lectureTimeArrayList.get(position).getLectureTime_Type();
                    lectureTypeTV.setText(lectureType);*/

                    lectureTypeTV.setText("");


                    LectureTime lectureTime2 = (LectureTime) parent.getItemAtPosition(position);


                    Lecture_Id = lectureTime2.getLectureTime_Id();
                    lectureTime = lectureTime2.getLectureTime_Name().toString();

                    new AsyncTask<String, Void, Void>() {
                        @Override
                        protected Void doInBackground(String... params) {
                            SoapObject request = new SoapObject(webServiceClass5.getNAMESPACE(), webServiceClass5.getMETHOD_NAME10());

                            request.addProperty("lecture_Id", Lecture_Id);
                            request.addProperty("lectureTime", lectureTime);
                            ...
                            HttpTransportSE httpTransportSE = new HttpTransportSE(webServiceClass5.getURL());
                            try {
                                httpTransportSE.call(webServiceClass5.getNAMESPACE()+webServiceClass5.getMETHOD_NAME10(), envelope);
                                SoapPrimitive response = (SoapPrimitive) envelope.getResponse();
                                String result = response.toString();
                                ...
                                JSONArray jsonArray = new JSONArray(result);
                                    ...
                                    for (int i = 0; i < jsonArray.length(); i++) {
                                        ...
                                        if(result.contains("Response")){
                                            if(jsonObject.getString("Response").isEmpty()){

                                            }else{
                                                lectureType = jsonObject.getString("Response");
                                            }

                                        }else{
                                            lectureType = jsonObject.getString("LectureType");
                                        }
                        ...
                        protected void onPostExecute(Void aVoid) {
                            ...
                            if(lectureType == null){
                                ...
                                if (lectureType.toString().equals("Time Limit Exceeds")) {

                                    String msg = lectureType;
                                    Toast.makeText(getApplicationContext(), msg, Toast.LENGTH_LONG).show();
                                } else {
        ...
        mark_date.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        ...
        if (v== button){
            ...
            if(lectureTypeTV.getText().toString() == "") {

                Toast.makeText(getApplicationContext(),"Please Select All",Toast.LENGTH_LONG).show();

            }else {

                Intent intent = new Intent(getApplicationContext(), MarkAttendanceStudentList.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.logout) {
            ...
            Intent i=new Intent(MarkAttendanceClassActivity.this,LoginActivity.class);
            startActivity(i);
